...
// clientConnected records a successfully-established frame-specific terminal
// websocket. The opaque attempt is generated by the parent UI and never exposed
// through the general status API.
func (m *ttydManager) clientConnected(sessionName, attempt string) {
	m.mu.Lock()
	defer m.mu.Unlock()
